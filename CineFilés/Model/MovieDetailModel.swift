    ...
    static func sample() -> [MovieDetailModel] {
        [
            MovieDetailModel(
                ...
                image: "shrek-2",
                description: "Shrek conhece os pais de Fiona e enfrenta desafios em um reino encantado.",
                streaming: ["netflix", "globoplay", "disney-plus"],
                imdb: "7.3 / 10",
                direction: "Andrew Adamson, Kelly Asbury, Conrad Vernon",
                year: "2004",
                rating: 0,
                isFavorite: false,
                isSeen: false
            ...
            MovieDetailModel(
                ...
                category: ["Suspense"],
                image: "terrifier-3",
                description: "A continuação sangrenta da saga do palhaço Art promete mais terror na época do Natal.",
                streaming: ["amazon", "max"],
                imdb: "6,3 / 10",
                direction: "Damien Leone",
                year: "2024",
                rating: 0,
                isFavorite: false,
                isSeen: false
            ...
            MovieDetailModel(
                ...
                image: "as-branquelas",
                description: "Dois agentes do FBI se disfarçam como socialites brancas para investigar um plano de sequestro.",
                streaming: ["netflix", "starplus"],
                imdb: "5.7 / 10",
            ...
            MovieDetailModel(
                ...
                image: "o-iluminado",
                description: "Durante o inverno, um homem enlouquece enquanto cuida de um hotel isolado com sua família.",
                streaming: ["amazon", "max"],
                imdb: "8.4 / 10",
            ...
            MovieDetailModel(
                ...
                category: ["Ação"],
                image: "watchmen",
                description: "Quando um de seus antigos colegas é assassinado, o vigilante mascarado Rorschach descobre um plano para matar e desacreditar todos os super-heróis do passado e do presente. À medida que ele se reconecta com sua antiga legião de combate ao crime, um grupo desorganizado de super-heróis aposentados, dentre os quais somente um possui verdadeiros poderes, Rorschach vislumbra uma ampla e perturbadora conspiração que está ligada ao passado deles e a catastróficas consequências para o futuro.",
                streaming: ["amazon", "disney-plus"],
                imdb: "7.6 / 10",
            ...
            MovieDetailModel(
                ...
                category: ["Animação", "Aventura", "Comédia"],
                image: "shrek",
                description: "Um ogro ranzinza parte em uma missão para salvar uma princesa e acaba descobrindo o verdadeiro amor.",
                streaming: ["netflix", "globoplay", "disney-plus"],
                imdb: "7.9 / 10",
                direction: "Andrew Adamson, Vicky Jenson",
                year: "2001",
                rating: 0,
                isFavorite: false,
                isSeen: false
            ...
            MovieDetailModel(
                ...
                streaming: ["netflix", "apple-tv", "globoplay"],
                imdb: "7.5 / 10",
            ...
            MovieDetailModel(
                ...
                streaming: ["disney-plus", "apple-tv", "max"],
                imdb: "7.1 / 10",
            ...
            MovieDetailModel(
                title: "Parasita",
                category: ["Comédia", "Drama", "Suspense"],
                image: "parasita",
